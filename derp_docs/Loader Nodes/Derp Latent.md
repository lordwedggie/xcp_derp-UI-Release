...
<span style="color: #ffc680"><strong>Note:</strong></span> This node broadcasts its output as a wireless signal, you'll need a [derpRouter](../Management%20Nodes/Derp%20Router.md) to route it. 
