...
<span style="color: #ffc680"><strong>Important:</strong></span> This loader needs [[Management Nodes/Derp Router|derpRouter]] to function. Without it, it's just a decorative rectangle.
