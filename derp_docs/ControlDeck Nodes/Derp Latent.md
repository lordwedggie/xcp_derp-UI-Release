...
<span style="color: #ffc680"><strong>Note:</strong></span> This node broadcasts its output as a wireless signal. If you're using derp loaders downstream, you'll need a [[Management Nodes/Derp Router|derpRouter]] to route it. 
