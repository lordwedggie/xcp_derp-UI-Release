...
from .python.derpSeedV3 import NODE_CLASS_MAPPINGS as SEED_V3_NODES, NODE_DISPLAY_NAME_MAPPINGS as SEED_V3_DISPLAY
...
NODE_CLASS_MAPPINGS.update(SEED_V3_NODES)
